...
with(this){return _c('p',[_v("VolunTier is the "),_c('strong',[_v("top "),_c('em',[_v("Tier")])]),_v(" solution for volunteer organisations that specialise in teaching students and are\nlooking to manage your growing clientele in an efficient manner.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("VolunTier is designed for those of you who are "),_c('strong',[_v("familiar with the Command Line Interface (CLI)")]),_v(" living in Singapore,\nsimplifying the process of adding, editing and deleting your volunteers, students and the lessons that they share.")])}
},function anonymous(
) {
...
with(this){return _c('h4',{attrs:{"id":"on-macos"}},[_v("On macOS:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#on-macos","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs shell"}},[_c('span',[_v("Cmd + Space\n")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"on-windows"}},[_v("On Windows:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#on-windows","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"on-linux"}},[_v("On Linux:"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#on-linux","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('pre',[_c('code',{pre:true,attrs:{"class":"hljs shell"}},[_c('span',[_v("Ctrl + Alt + T\n")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"features"}},[_v("Features"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#features","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Views the details of the person at the specified "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("INDEX")]),_v(".")]),_v(" "),_c('li',[_v("The index refers to the index number shown in the displayed person list.")]),_v(" "),_c('li',[_v("The index "),_c('strong',[_v("must be a positive integer")]),_v(" 1, 2, 3, …​")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("If you accidentally deleted a person, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("undo")]),_v(" will add that person back.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("History displays only commands executed during the current session.")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 7 Nov 2024, 17:27:30 GMT+8]")])])])}
}];
